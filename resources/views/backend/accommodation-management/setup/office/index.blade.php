                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header text-right">
                            <a href="{{route('admin.accommodation-management.setup.office.create')}}" class="btn btn-sm btn-info"><i class="fas fa-plus"></i> @lang('Setup Office')</a>
                        </div>
                        <div class="card-body">
                             @include('backend.accommodation-management.setup.office.grid') 
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
