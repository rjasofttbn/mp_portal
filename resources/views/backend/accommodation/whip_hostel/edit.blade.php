                                ...
                                <div class="form-group">
                                    ...
                                    <select style="width:222px;" id="hostel_building_id" name="hostel_building_id" class="form-control @error('hostel_building_id') is-invalid @enderror">
                                        ...
                                        @foreach ($hostelBuildingList as $list)
                                                ...
                                                <option 
                                                @if($list->id== $proposedHostelBuildingId)
                                            selected
                                            @endif
  ...
  onOpen:function(){
	$('#datepicker').datepicker({
        ...
        if (result.value) {
          ...
          $.ajax({
            url: '{{url("confirmUpdatedHostelApplicationByWhip")}}',
            type: "get",
            data: {
            ...
            success: function(response) {
              ...
              var pos = loc.indexOf("whip_hostel_application_monitoring");
           
   var urlpart= loc.slice(0, (pos+34));
