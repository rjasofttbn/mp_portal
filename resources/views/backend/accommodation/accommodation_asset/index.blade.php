                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header text-right">
                            <a href="{{route('admin.accommodation-asset-management.setup.accommodation_assets.create')}}" class="btn btn-sm btn-info"><i class="fas fa-plus"></i> @lang('Add Accommodation Asset')</a>
                        </div>
                        <div class="card-body">
