...
$(document).on('click','#search',function(){
    ...
    $.ajax({
        url : "{{url('/admin/accommodation/applications/application/application-monitoring-data-for-whip')}}",
    ...
    $(document).on('click', '.approve', function() {
      ...
      Swal.fire({
        ...
        if (result.value) {
            var id = $(this).data('id');
          $.ajax({
            url: '{{url('/admin/accommodation/applications/application/application-monitoring-data-for-whip-approve')}}',
            type: "get",
            data: {id:id},
