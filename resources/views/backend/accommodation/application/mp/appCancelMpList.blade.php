...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">@lang('Manage Accommodation Cancel Application')</h4>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-lg-12">
                                ...
                                @foreach($acc_app as $list)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            {{-- <a class="btn btn-sm btn-info" href="{{url('admin/accommodation/applications/application/flat/approve_application',$list->id)}}">
                                                <i class="fa fa-eye"></i>
                                            </a>     --}}
                                            <a class="btn btn-sm btn-info" href="{{route('admin.accommodation.applications.mp.viewAppPendingCancel',$list->id)}}">
                                                <i class="fa fa-eye"></i>
                                            </a>   
                    ...
                    <div class="card"style="margin-top: 171px; text-align:center;">
                      <div class="card-body">
                      <h3 style="color: red;">@lang('There is no flat allocation in your name, which you want to cancel.')</h3>
                  </div>
              </div>
              @endif 
                </div>
