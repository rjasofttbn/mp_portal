...
<div class="main">
    ...
    <div class="subject">বিষয়ঃ-  উচ্চমান আবাসন বরাদ্দ বাতিল প্রসঙ্গে ।</div><br>
...
এখন আমি বসবাস করতেছি {{$app_data[0]->ar_name_bn}} {{ $app_data[0]->hb_name_bn}} ।<br>
এমতাবস্থায়, উক্ত বরাদ্দকৃত উচ্চমান আবাসন বাতিলের জন্য প্রয়োজনীয় ব্যবস্থা গ্রহনের জন্য বিশেষভাবে অনুরোধ জানাচ্ছি ।
  </div>
    <div class="outer">
        <div class="right">
            ধন্যবাদান্তে <br>
