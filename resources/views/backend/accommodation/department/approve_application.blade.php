...
$(document).on('click','#search',function(){
    var accommodation_application_id = "{{$accommodation_application->id}}";
    var area_id = $('#area_id').val();
    var building_id = $('#building_id').val();
    $.ajax({
        url : "{{url('accommodation-flat-list-by-building')}}",
        data : {area_id:area_id,building_id:building_id,accommodation_application_id:accommodation_application_id},
        type : "get",
        beforeSend : function(){
            $('.preload').show();
        },
    ...
    $(document).on('click', '#confirm', function() {
      Swal.fire({
        ...
        if (result.value) {
          ...
          var accommodation_application_id = $(this).data("accommodation_application_id");
          ...
          $.ajax({
            ...
            data: {
                flat_id:flat_id,
                accommodation_application_id:accommodation_application_id,
