                ...
                <table id="pending_table" class="table table-sm table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a style="margin-left:2px;" class="btn btn-sm btn-info" href="{{url('/admin/accommodation/applications/application/application_monitoring/flat/approve_application',$list->id)}}"><i class="fa fa-check"></i></a>
                                <a style="margin-left:2px;" class="btn btn-sm btn-danger reject_accommodation" data-id="{{$list->id}}"><i class="fa fa fa-times"></i></a>
                            </td>
                        </tr>
                            @endforeach
                    </tbody>
