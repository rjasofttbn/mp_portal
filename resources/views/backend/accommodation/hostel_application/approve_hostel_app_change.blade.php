...
<table  style="width: 100%;">
   ...
   <tr>
    ...
    <div class="subject">বিষয়ঃ-  শেরেবাংলা নগর সদস্য ভবনের অফিস কক্ষ পরিবর্তন।</div><br>
    <div class="mohdoy">মহোদয়,</div>
    <div class="header_content_acc">                
        বাংলাদেশ জাতীয় সংসদ সচিবালয়ের আওতাধীন শেরেবাংলা নগর সদস্য ভবনের {{ $app_data[0]->hostel_fl_bn.' '.$app_data[0]->hostel_ofr_bn }}  নং অফিস কক্ষ নির্দেশক্রমে নিম্নবর্ণিত শর্তে পরিবর্তন করা হলো ।
  </div>
