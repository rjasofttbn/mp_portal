...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">@lang('Manage Accommodation Change Application (Hostel)')</h4>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                ...
                                @foreach($acc_app as $list)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-sm btn-success" href="{{route('admin.accommodation.applications.hostel_application.viewHostelAppPending',$list->id)}}">
                                                <i class="fa fa-eye"></i>
                                            </a>
