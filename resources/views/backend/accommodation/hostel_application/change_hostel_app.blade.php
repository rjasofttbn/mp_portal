...
<div class="main">
    ...
    <div class="subject">বিষয়ঃ-  অফিস কক্ষ পরিবর্তন প্রসঙ্গে ।</div><br>
    ...
    <div class="header_content_acc">                
        আপনার সদয় দৃষ্টি আকর্ষণ করে জানাচ্ছি যে, আমার সংসদীয় এলাকা {{ $app_data[0]->number. ' '. $app_data[0]->con_bn_name}} এবং
         শেরেবাংলা নগর সদস্য {{$app_data[0]->hostel_bu_bn}} ভবনে {{$app_data[0]->hostel_ofr_bn}} নং অফিস কক্ষ বাতিল করে শেরেবাংলা নগর সংসদ-সদস্য ভবনে অন্য একটি অফিস কক্ষ একান্ত প্রয়োজন ।

         <br>
         এমতাবস্থায়, উক্ত বরাদ্দকৃত অফিস কক্ষ পরিবর্তন জন্য প্রয়োজনীয় ব্যবস্থা গ্রহনের জন্য বিশেষভাবে অনুরোধ জানাচ্ছি ।
