...
<div class="main">
    ...
    <div class="subject">বিষয়ঃ-  অফিস কক্ষ বরাদ্দ প্রসঙ্গে।</div><br>
    <div class="mohdoy">প্রিয় মহোদয়,</div>
    <div class="header_content_acc">                
        আপনার সদয় দৃষ্টি আকর্ষণ করে জানাচ্ছি যে, আমার সংসদীয় এলাকা {{ $app_data[0]->number. ' '. $app_data[0]->con_bn_name}} এবং শেরেবাংলা নগর সদস্য {{$app_data[0]->hostel_bu_bn}} ভবনে একটি অফিস কক্ষ একান্ত প্রয়োজন ।
  </div>
    <div class="outer">
        <div class="right">
            ধন্যবাদান্তে <br>
