                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4">
                                        <select id="hostel_building_id" name="hostel_building_id" class="form-control @error('hostel_building_id') is-invalid @enderror hostel_building_id hostel_building_id">
                                            ...
                                            @foreach ($hostelBuildingList as $lista)
                                                @if($lista->id== $data['editData']['hostel_building_id']) or $lista->id==old(hostel_building_id))
                                                    <option selected
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-7 col-lg-7">
                                        ...
                                        placeholder="@lang('Change Reason')" autocomplete="off">
                                        @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
        ...
        $('#submitForm').validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    url : "{{(@$data['editData'])?route('admin.accommodation.hostel_application.update',@$data['editData']['id']):route('admin.accommodation.hostel_application.store') }}",
                    data : formInfo,
                    type : "POST",
                    processData: false,
                    contentType: false,
