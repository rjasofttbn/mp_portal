        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="noticeCreateForm" class="form-horizontal" action="{{route('admin.notice_management.notices.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="rule_id" id="rule_id" value="{{ $ruleData->id }}">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12 col-md-2 col-lg-2">
                                <label class="control-label" for="parliament_session">@lang('4'). @lang('Parliament Session') <span class="text-danger"> *</span></label>
                            </div>
                            <div class="col-sm-12 col-md-10 col-lg-10">
                                <select id="parliament_session" name="description[parliament_session]" class="@error('description.parliament_session') is-invalid @enderror form-control select2">
                                    ...
                                    <option value="2" {{ old('description.question_type') == '2' ? 'selected' : '' }}>প্রধান মন্ত্রীর প্রশ্ন</option>
                                    <option value="1" {{ old('description.parliament_session') == '1' ? 'selected' : '' }}>চলতি অধিবেশন</option>
                                    <option value="0" {{ old('description.parliament_session') == '0' ? 'selected' : '' }}>আসন্ন অধিবেশন</option>
                                </select>
                                <div>
