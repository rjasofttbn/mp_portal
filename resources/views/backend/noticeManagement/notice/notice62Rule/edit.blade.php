...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-10 col-lg-10">
            <textarea id="brief_statement" name="description[brief_statement]" class="textareaWithoutImgVideo form-control @error('description.brief_statement') is-invalid @enderror">
            {{old('brief_statement') ?? $descriptions->brief_statement ?? '' }}
            </textarea>
