                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-10 col-lg-10">
                                <select id="raise_amendment" name="bill_topic" data-id="{{ $editData->bill_topic }}" class="@error('bill_topic') is-invalid @enderror form-control form-control-sm select2">
                                    ...
                                    <option {{ $editData->bill_topic == 1 ? 'selected' : '' }} value="1">@lang('দফার পরিবর্তে দফা সন্নিবেশ')</option>
                                    <option {{ $editData->bill_topic == 2 ? 'selected' : '' }} value="2">@lang('নতুন দফা সংযোজন')</option>
                                    <option {{ $editData->bill_topic == 3 ? 'selected' : '' }} value="3">@lang('শর্ত-দফা সংযোজন')</option>
                                    <option {{ $editData->bill_topic == 4 ? 'selected' : '' }} value="4">@lang('শব্দটি/শব্দাবলী বর্জন')</option>
                                    <option {{ $editData->bill_topic == 5 ? 'selected' : '' }} value="5">@lang('শব্দাবলী সন্নিবেশ')</option>
                                    <option {{ $editData->bill_topic == 6 ? 'selected' : '' }} value="6">@lang('প্যারার পরিবর্তে প্যারা সন্নিবেশ')</option>
                                    <option {{ $editData->bill_topic == 7 ? 'selected' : '' }} value="7">@lang('শব্দাবলী বর্জন এবং শব্দাবলীর পরিবর্তে নতুন শব্দাবলী সন্নিবেশ')</option>
                                </select>
                                <div>
                                    @error('bill_topic')
                                    <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-8 col-lg-8">
                                            ...
                                            class="form-control @error('description.exchange_words_para') is-invalid @enderror" placeholder="প্যারা নং লিখুন">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-8 col-lg-8">
                                            ...
                                            class="form-control @error('description.exchange_words_line') is-invalid @enderror" placeholder="পংক্তি নং লিখুন">
