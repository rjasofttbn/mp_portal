<form id="parliamentForm" name="parliamentForm" method="POST"
    action="{{ route('admin.appointment-management.appointment-received.appointment_update', $data->id) }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <label class="control-label">@lang('New Appointment Date') : {{ $data->new_date }}</label>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <label class="control-label">@lang('New Appointment Time') : {{ $data->new_time_from }} to
                                {{ $data->new_time_to }}</label>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <label class="control-label">@lang('New Place') : {{ $data->new_place }}</label>
                        </div>
                        <div class="col-sm-12">
                            <label class="control-label">@lang('Purpose of Appointment') :
                                {{ $data->topics }}</label>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                    <input type="text"
                                        ...
                                        name="date" value="{{ old('date', $data->new_date) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="reservationtimefrom" data-target-input="nearest">
                                    <input type="text"
                                        ...
                                        name="time_from" value="{{ old('time_from', $data->new_time_from) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="reservationtimeto" data-target-input="nearest">
                                    <input type="text"
                                        ...
                                        name="time_to" value="{{ old('time_to', $data->new_time_to) }}"
                                        placeholder="@lang('Select Time')" autocomplete="off" maxlength="30"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="place" name="place" class="form-control"
                                    value="{{ old('place', $data->new_place) }}" placeholder="@lang('Type Place')" />
