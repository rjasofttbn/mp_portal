                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label" for="place_type">@lang('Select member')<span style="color: red;"> *</span></label>
                                <select id="place_type" name="place_type" class="form-control @error('place_type') is-invalid @enderror select2">
                                    @php
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select id="designition_id" name="designition_id" class="form-control @error('designition_id') is-invalid @enderror select2">
                                    <option value="">@lang('Select Designation')</option>
                                    @foreach ($designation as $list)
                                    @if($list->id==$data->designition_id)
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="num_of_telephone" name="num_of_telephone" value="{{old('room', $data->num_of_telephone)}}" class="form-control @error('num_of_telephone') is-invalid @enderror" placeholder="@lang('Enter Number of Telephone')" autocomplete="off" maxlength="30">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="num_of_pabx" name="num_of_pabx" onkeydown="removeSpecials(event)" value="{{old('num_of_pabx', $data->num_of_pabx)}}" class="form-control @error('num_of_pabx') is-invalid @enderror" placeholder="@lang('Enter Number of PABX')" autocomplete="off" maxlength="30">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label" for="num_of_mobile">@lang('mobile number')<span style="color: red;"> *</span></label>
                                <input type="text" id="num_of_mobile" name="num_of_mobile" onkeydown="removeSpecials(event)" value="{{old('num_of_mobile', $data->num_of_mobile)}}" class="form-control @error('num_of_mobile') is-invalid @enderror" placeholder="@lang('Enter Number of Mobile')" autocomplete="off" maxlength="30">
