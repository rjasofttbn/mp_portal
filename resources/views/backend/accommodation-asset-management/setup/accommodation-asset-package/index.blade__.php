                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header text-right">
                            <a href="{{route('admin.master_setup.assessment_committees.create') }}" class="btn btn-sm btn-info"><i class="fas fa-plus"></i> @lang('Create Committee')</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    @foreach ($committees as $data)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-sm btn-info" href="{{route('admin.master_setup.assessment_committees.edit', $data->id)}}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a class="btn btn-sm btn-danger destroy"
                                                data-route="{{route('admin.master_setup.assessment_committees.destroy' , $data->id)}}">
