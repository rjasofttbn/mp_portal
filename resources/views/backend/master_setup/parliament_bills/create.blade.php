        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title w-100">@lang('Create Parliamentary Bill')
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.master_setup.parliament_bills.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-12">
                                <div class="callout callout-info">
                                    ...
                                    <div class="clause-main">
                                       <livewire:parliament-bill.more-clause />
                                    </div>
                                </div>
                            </div>
