                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-8 col-lg-8">
                                        <select name="minister_id" id="minister_id" class="@error('minister_id') is-invalid @enderror form-control form-control-sm select2">
                                            ...
                                            <option value="{{ $data->id }}" @if($data->id == old('minister_id') || $data->id==$existing_record->minister_id) {{'selected="selected"'}} @endif >{{ $data->name_bn }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-8 col-lg-8">
                                        <select name="state_minister[]" multiple='multiple' id="state_minister" class="@error('state_minister') is-invalid @enderror form-control form-control-sm select2">
                                            ...
                                            @foreach ($profile_list as $data)
                                            <option value="{{ $data->id }}" @if($data->id == old('state_minister') || in_array($data->id,$existing_state_minister)) {{'selected="selected"'}} @endif >{{ $data->name_bn }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-8 col-lg-8">
                                        <select name="deputy_minister[]" multiple='multiple' id="deputy_minister" class="@error('deputy_minister') is-invalid @enderror form-control form-control-sm select2">
                                            ...
                                            @foreach ($profile_list as $data)
                                            <option value="{{ $data->id }}" @if($data->id == old('deputy_minister') || in_array($data->id,$existing_deputy_minister)) {{'selected="selected"'}} @endif >{{ $data->name_bn }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-8 col-lg-8">
                                        <select name="secretary[]" multiple='multiple' id="secretary" class="@error('secretary') is-invalid @enderror form-control form-control-sm select2">
                                            ...
                                            @foreach ($profile_list as $data)
                                            <option value="{{ $data->id }}" @if($data->id == old('secretary') || in_array($data->id,$existing_secretary)) {{'selected="selected"'}} @endif >{{ $data->name_bn }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-8 col-lg-8">
                                        <select name="joint_secretary[]" multiple='multiple' id="joint_secretary" class="@error('joint_secretary') is-invalid @enderror form-control form-control-sm select2">
                                            ...
                                            @foreach ($profile_list as $data)
                                            <option value="{{ $data->id }}" @if($data->id == old('joint_secretary') || in_array($data->id,$existing_joint_secretary)) {{'selected="selected"'}} @endif >{{ $data->name_bn }}</option>
                                            @endforeach
                                        </select>
